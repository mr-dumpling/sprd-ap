...
@param = (
   ...
   ["ProdNV"        , "$outBinPath/prodnv.img", 	1        , 1        , 0        , 0x0       , 0xFFFFFFFF  ],
   ...
   ["System"        , "$outBinPath/system.img", 	1        , 1        , 0        , 0x0       , 0xFFFFFFFF  ],
   ["UserData"      , "$outBinPath/userdata.img", 1        , 1        , 0        , 0x0       , 0xFFFFFFFF  ],
   ...
   ["Cache"         , "$outBinPath/cache.img", 		1        , 1        , 1        , 0x0       , 0xFFFFFFFF  ],
